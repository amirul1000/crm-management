...
<div class="card">
   <div class="card-body">    
        <div class="form-group"> 
          ...
          <div class="col-md-8"> 
           <input type="text" name="name" value="<?php echo ($this->input->post('name') ? $this->input->post('name') : $users['name']); ?>" class="form-control" id="name" /> 
          </div> 
           </div>
<div class="form-group"> 
...
<div class="form-group"> 
          ...
          <div class="col-md-8"> 
           <?php 
             $enumArr = $this->customlib->getEnumFieldValues('users','role'); 
           ?> 
           <select name="role"  id="role"  class="form-control"/> 
             ...
             <?php 
              ...
              { 
             ?> 
             <option value="<?=$enumArr[$i]?>" <?php if($users['role']==$enumArr[$i]){ echo "selected";} ?>><?=ucwords($enumArr[$i])?></option> 
             <?php 
              } 
             ?> 
           </select> 
